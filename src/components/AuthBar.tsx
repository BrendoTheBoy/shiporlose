  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex items-center gap-2 min-w-0">
        ...
        <span className="font-mono text-[10px] uppercase text-[#39FF14] truncate max-w-[120px] sm:max-w-[180px]">
      ...
      <button
        ...
        className="border-2 border-[#FF6B00] bg-[#0a0a0a] px-2 py-1 font-mono text-[9px] uppercase tracking-wide text-[#FF6B00] hover:bg-[#120a04]"
      >
        LOGOUT
      </button>
    </div>
